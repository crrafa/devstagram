        ...
        <div class="md:w-4/12 bg-white p-5 rounded-lg shadow-xl">
            <form action="{{route('register')}}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="email" name="email" id="email" placeholder="Email de registro" class="border p-3 w-full rounded-lg">
                </div>
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Password de Registro" class="border p-3 w-full rounded-lg">
                </div>
